...
type RecorderModifier func(r *httpreplay.Recorder)
...
func NewRecordReplayClient(ctx context.Context, t *testing.T, rf RecorderModifier, opts ...option.ClientOption) (c *http.Client, cleanup func()) {
