...
1. Build your changes using `vgo build .`, _do not use `go`_. Go X Cloud only supports `vgo` in order to ensure [reproducible builds](https://research.swtch.com/vgo-repro).
